...
SECRET_KEY = os.getenv('SECRET_KEY','django-insecure-qbj5tso!0b7g-8h3tj!4dk@rspfbou86sy9omm)4+@(--=f$nz')
...
ROOT_URLCONF = 'traffic_mngt.urls'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.getenv('DB_MYSQL_DATABASE', 'traffic_mngt'),
