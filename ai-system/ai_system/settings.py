"""
Django settings for traffic_mngt project.
...
SECRET_KEY = os.getenv('SECRET_KEY','django-insecure-qbj5tso!0b7g-8h3tj!4dkkjdfalkw34il32k#')
...
WSGI_APPLICATION = 'ai_system.wsgi.application'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.getenv('DB_MYSQL_DATABASE', 'ai_system'),
